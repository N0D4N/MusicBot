...
public class TimeUtilTest
{
    ...
    {
        var seek = TimeUtil.parseTime("99:9:999");
        assertNotNull(seek);
    ...
    {
        var seek = TimeUtil.parseTime("99.5:9.0:999.777");
        assertNotNull(seek);
    ...
    {
        var seek = TimeUtil.parseTime("1:1:1:1");
        assertNull(seek);
    ...
    {
        var seek = TimeUtil.parseTime("+-1:-+1:+-1");
        assertNull(seek);
    }
    ...
    {
        var seek = TimeUtil.parseTime("1:1:a");
        assertNull(seek);
