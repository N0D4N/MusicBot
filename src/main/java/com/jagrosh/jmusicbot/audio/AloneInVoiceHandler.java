...
public class AloneInVoiceHandler
{
    ...
    public void onVoiceUpdate(GuildVoiceUpdateEvent event)
    {
        ...
        var alone = AloneInVoiceHandler.isAlone(guild);
        var inList = aloneSince.containsKey(guild.getIdLong());
